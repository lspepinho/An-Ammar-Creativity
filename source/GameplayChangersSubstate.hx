...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var option:GameplayOption = new GameplayOption('Distractions', 'mechanics', 'bool', true);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Modchart', 'modchart', 'bool', true);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Special Notes', 'specialnotes', 'bool', true);
		optionsArray.push(option);
	...
	public function new()
	{
		...
		grpOptions.camera = daCam;
		add(grpOptions);

		grpTexts = new FlxTypedGroup<AttachedText>();
		grpTexts.camera = daCam;
		add(grpTexts);

		checkboxGroup = new FlxTypedGroup<CheckboxThingie>();
		checkboxGroup.camera = daCam;
		add(checkboxGroup);
