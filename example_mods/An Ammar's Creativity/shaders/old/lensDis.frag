...
void mainImage() {
    ...
    float red = texture( bitmap, computeUV( uv, k + offset, kcube )).r; 
    float green = texture( bitmap, computeUV( uv, k, kcube )).g; 
    float blue = texture( bitmap, computeUV( uv, k - offset, kcube )).b; 
